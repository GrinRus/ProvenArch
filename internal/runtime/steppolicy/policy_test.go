...
func TestAsIsFirstActionSectionWritesEvidenceBackedDraftSetFirst(t *testing.T) {
	...
	required := []string{
		...
		`Architecture Home must not mention run IDs, current-run analysis, pipeline step names, collect passes, typed shard plans/summaries, shard-pack manifests, completeness counters`,
