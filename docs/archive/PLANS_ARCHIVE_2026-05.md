...
## Reconciled active plans from 2026-05-07

Original active-plan text preserved during tracker reconciliation. Open work was consolidated into `EP-20260507-trusted-live-validation`, `EP-20260507-provider-reporting-refactor`, and `EP-20260507-cleanup-owner-decisions`; detailed classification lives in `docs/archive/TRACKER_RECONCILIATION_2026-05-07.md`.
