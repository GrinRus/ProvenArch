...
2) MVP scope фиксирован: local-first как основной режим + Claude Code headless как единственный runtime.
...
8) MVP extraction strategy не ограничивается фиксированным whitelist языков/стэков; используется Claude Code + baseline prompt/skill bundle, а при нехватке evidence фиксируются unknowns.
