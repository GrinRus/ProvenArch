...
| Weak-model validation and promotion hardening | planned; authority decision accepted (Epic 24) | [`ADR-20260811-validation-audit-effective-verdict-authority.md`](adr/ADR-20260811-validation-audit-effective-verdict-authority.md) fixes provider draft → technical candidate → provider-free pre-promotion audit → effective verdict; implementation has not started. |
