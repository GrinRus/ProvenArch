# PLANS Archive (2026-04)

Архив завершённых планов, вынесенных из `docs/PLANS.md` для снижения шума в рабочем документе.

- Дата архивации: 2026-04-15
- Источник: `docs/PLANS.md`
- Политика: сюда переносятся закрытые исторические планы; активные и недавно рабочие планы остаются в `docs/PLANS.md`.
...
- `scripts/tests/*` (historical regression tests; removed in cleanup 2026-04-15)
- `README.md`
...
- 2026-04-14: Реализованы `profiles × sweeps`, strict release verdict artifacts (`release_verdict_<matrix-id>.md/.json`), runtime-flow checks (sharding/repo-selection/execution semantics), обновлены примеры/доки, добавлены regression tests (scripts/tests, позже удалены в cleanup 2026-04-15).
...
### Progress log
- 2026-04-13: Удалены `unused import` в `scripts/e2e_batch_report.py` (`math`) и в historical regression test module (позже удалён в cleanup 2026-04-15).
...
- 2026-04-03: Добавлены scenario fixtures, deterministic scenario integration tests, smoke scripts и CI workflows (`golden`, `smoke-cli`, `smoke-api`, `ui-smoke`, optional `live-runner-smoke`; `ui-smoke` удалён в cleanup 2026-04-15).
...
- `internal/api/docs surface` (`internal/api/README.md` на момент выполнения плана; удалён в cleanup 2026-04-15)
- `README.md`
...
- 2026-04-15: Optional manual workflow `ui-live-smoke-optional` удалён в cleanup срезе как лишний CI surface.
...
## Archived Plans (additional, 2026-04-15)
