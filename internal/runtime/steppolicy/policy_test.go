...
func TestDocFirstFilesystemPolicyDefinesSharedCollectRepairSurface(t *testing.T) {
	...
	required := []string{
		...
		`Cap that first action to at most 8 representative files and at most the first 6000 bytes from each file`,
...
func TestCollectFirstActionSectionDefinesEvidenceFirstTargets(t *testing.T) {
	...
	required := []string{
		...
		`Do not use generated source-code strings, Python f-strings, .format templates, or nested quote tricks`,
