...
func TestComposeCollectArtifactPairRepairPromptWritesExactPairFirst(t *testing.T) {
	...
	expectedTokens := []string{
		...
		"The command writes a marker-bearing recovery bootstrap pair",
		"After the command succeeds, do one targeted evidence pass",
		...
		"unchanged recovery bootstrap pair is an artifact_quality blocker",
