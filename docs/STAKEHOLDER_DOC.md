...
| Weak-model validation and promotion hardening | in progress; W24A–W24F implemented | [`ADR-20260811-validation-audit-effective-verdict-authority.md`](adr/ADR-20260811-validation-audit-effective-verdict-authority.md) fixes provider draft → technical candidate → provider-free pre-promotion audit → effective verdict; recovery budget/conformance closure remains W24G–W24I. |
