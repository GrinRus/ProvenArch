...
| Code quality audit remediation | in progress (Epic 19 / PR-1) | `docs/CODE_AUDIT_2026-07-10.md` + `docs/BACKLOG.md` Epic 19: crash consistency, lifecycle, contracts, UI correctness/accessibility and deterministic CI; PR-1 starts with `19A` atomic persistence and run-history last-good recovery. Local frontend security hardening remains Wave 1+ non-goal |
