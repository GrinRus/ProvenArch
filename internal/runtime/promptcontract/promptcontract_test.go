...
func TestComposeDraftArtifactEnrichmentPromptAvoidsBootstrapHeredoc(t *testing.T) {
	...
	for _, token := range []string{
		...
		"In overview.md, never mention run IDs, current-run analysis, pipeline step names, collect passes, typed shard plans/summaries, shard-pack manifests, completeness counters",
