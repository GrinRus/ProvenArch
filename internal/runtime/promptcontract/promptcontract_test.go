...
func TestComposeCollectArtifactPairRepairPromptWritesExactPairFirst(t *testing.T) {
	...
	expectedTokens := []string{
		...
		"The command writes a marker-free, validation-ready recovery fallback pair",
		...
		"Exiting successfully immediately after the heredoc command is valid only when the written pair remains marker-free",
