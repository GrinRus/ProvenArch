...
export function ReviewStagePanel({
  ...
  return (
    <div className="stage-stack" data-testid="review-panel">
      <section className="panel stage-panel review-stage-panel" data-testid="results-coverage-panel">
        <div className="stage-header">
          <div>
...
function ChangesReviewBrief({ review }: { review: NonNullable<RunReviewSummaryResponse["review"]> }) {
  ...
  return <section className="changes-review-brief" data-testid="semantic-changes" aria-label="Selected change set summary">
    ...
    <details className="changes-review-brief-details">
      <summary>Review summary · {changeCount} semantic changes · {documentCount} document changes · {review.summary.findings} findings · {review.summary.gaps} coverage gaps</summary>
