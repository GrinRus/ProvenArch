...
- runtime collect repair policy is behavioral, not a separate schema; current manifest-only repair prompt rules are specified in `docs/spec/PIPELINE_SPEC.md`.
