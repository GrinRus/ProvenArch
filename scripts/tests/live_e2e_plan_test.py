...
class LiveE2EPlanTest(unittest.TestCase):
    ...
    def test_smoke_tiny_generates_one_repo_one_run_one_provider_command(self) -> None:
        ...
        self.assertEqual(env["ACP_CODEX_MODEL"], "gpt-5.5")
        self.assertEqual(env["ACP_CODEX_REASONING_EFFORT"], "xhigh")
    ...
    def test_shell_output_contains_direct_harness_commands_only(self) -> None:
        ...
        self.assertIn("ACP_CODEX_MODEL=gpt-5.5", result.stdout)
        self.assertIn("ACP_CODEX_REASONING_EFFORT=xhigh", result.stdout)
