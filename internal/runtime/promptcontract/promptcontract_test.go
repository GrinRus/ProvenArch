...
func TestComposeCollectArtifactPairRepairPromptIsEvidenceFirstNoSeed(t *testing.T) {
	...
	expectedTokens := []string{
		...
		"Do not answer with a plan, status note, or analysis-only message after the preflight",
		...
		"same command or the immediately following filesystem action must write shard-pack-manifest.json",
